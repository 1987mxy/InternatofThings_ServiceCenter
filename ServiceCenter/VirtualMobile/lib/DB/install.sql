...
INSERT INTO datapackage ( Name, Code, Struct, StructLabel, ExistReply, Encrypt, Memo ) VALUES ( 'PubKey', 1, 's', 'pubkey', 1, 'none', '公钥' );
INSERT INTO datapackage ( Name, Code, Struct, StructLabel, ExistReply, Encrypt, Memo ) VALUES ( 'Key', 2, 'Ls', 'password,pubkey', 1, 'rsa_public', '口令' );
